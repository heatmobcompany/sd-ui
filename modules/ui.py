                    ...
                    if category == "sampler":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="txt2img_column_size", scale=4):
                                ...
                                height = gr.Slider(minimum=64, maximum=1152, step=8, label="Height", value=512, elem_id="txt2img_height")
                            ...
                            if opts.dimensions_and_batch_together:
                                with gr.Column(elem_id="txt2img_column_batch"):
                                    ...
                                    batch_size = gr.Slider(minimum=1, maximum=2, step=1, label='Batch size', value=1, elem_id="txt2img_batch_size")
                        ...
                        with FormRow():
                            ...
                            if opts.dimensions_and_batch_together:
                                with gr.Column(elem_id="img2img_column_batch"):
                                    ...
                                    batch_size = gr.Slider(minimum=1, maximum=2, step=1, label='Batch size', value=1, elem_id="img2img_batch_size")
        ...
        with gr.Row(variant="compact").style(equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Preprocess images", id="preprocess_images"):
                    ...
                    process_width = gr.Slider(minimum=64, maximum=896, step=8, label="Width", value=512, elem_id="train_process_width")
                    process_height = gr.Slider(minimum=64, maximum=896, step=8, label="Height", value=512, elem_id="train_process_height")
                ...
                with gr.Tab(label="Train", id="train"):
                    ...
                    training_width = gr.Slider(minimum=64, maximum=896, step=8, label="Width", value=512, elem_id="train_training_width")
                    training_height = gr.Slider(minimum=64, maximum=896, step=8, label="Height", value=512, elem_id="train_training_height")
